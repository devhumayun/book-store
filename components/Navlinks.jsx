...
const links = [
    ...
    { name: 'Community', href: '/store/communites', icon: UserGroupIcon },
                ...
                links.map((link) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {
                                (link.name === "Cart" && cartData && cartData.length > 0 ? `${link.name} (${cartData.length})` : <p className="hidden md:block">{link.name}</p>)
                            }
